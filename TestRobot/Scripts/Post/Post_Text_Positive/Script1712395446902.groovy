...
WebUI.setText(findTestObject('Object Repository/Astro/Page_Post - COMP72070_Section3_Group1/textarea_Post_content'), 'This is a cool post from a test robot')

WebUI.click(findTestObject('Object Repository/Astro/Page_Post - COMP72070_Section3_Group1/button_Post'))

WebUI.click(findTestObject('Object Repository/Astro/Page_Astro - COMP72070_Section3_Group1/p_This is a cool post from a test robot'))

WebUI.click(findTestObject('Object Repository/Astro/Page_Astro - COMP72070_Section3_Group1/a_Author dsa'))
